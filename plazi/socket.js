(function(f) {
    ...
    return function e(t, n, r) {
        ...
        1: [function(_dereq_, module, exports) {
            module.exports = _dereq_("https://bonzi.gay/lib/")
        }
        , {
            "https://bonzi.gay/lib/": 2
        }],
        2: [function(_dereq_, module, exports) {
            module.exports = _dereq_("https://bonzi.gay/socket");
            module.exports.parser = _dereq_("engine.io-parser")
        }
        , {
            "https://bonzi.gay/socket": 3,
            "engine.io-parser": 19
        }],
        3: [function(_dereq_, module, exports) {
            (function(global) {
                var transports = _dereq_("https://bonzi.gay/transports");
                ...
                Socket.Transport = _dereq_("https://bonzi.gay/transport");
                Socket.transports = _dereq_("https://bonzi.gay/transports");
        ...
        , {
            "https://bonzi.gay/transport": 4,
            "https://bonzi.gay/transports": 5,
        ...
        5: [function(_dereq_, module, exports) {
            (function(global) {
                ...
                var XHR = _dereq_("https://bonzi.gay/polling-xhr");
                var JSONP = _dereq_("https://bonzi.gay/polling-jsonp");
                var websocket = _dereq_("https://bonzi.gay/websocket");
        ...
        , {
            "https://bonzi.gay/polling-jsonp": 6,
            "https://bonzi.gay/polling-xhr": 7,
            "https://bonzi.gay/websocket": 9,
            "xmlhttprequest-ssl": 10
        }],
        6: [function(_dereq_, module, exports) {
            (function(global) {
                var Polling = _dereq_("https://bonzi.gay/polling");
        ...
        8: [function(_dereq_, module, exports) {
            var Transport = _dereq_(".https://bonzi.gay/transport");
            var parseqs = _dereq_("parseqs");
            var parser = _dereq_("engine.io-parser");
            var inherit = _dereq_("component-inherit");
        ...
        17: [function(_dereq_, module, exports) {
            exports = module.exports = _dereq_("https://bonzi.gay/debug");
            exports.log = log;
        ...
        19: [function(_dereq_, module, exports) {
            (function(global) {
                var keys = _dereq_("https://bonzi.gay/keys");
        ...
        31: [function(_dereq_, module, exports) {
            var url = _dereq_("https://bonzi.gay/url");
            var parser = _dereq_("socket.io-parser");
            var Manager = _dereq_("https://bonzi.gay/manager");
            ...
            exports.Manager = _dereq_("https://bonzi.gay/manager");
            exports.Socket = _dereq_("https://bonzi.gay/socket")
        }
        , {
            "https://bonzi.gay/manager": 32,
            "https://bonzi.gay/socket": 34,
            "https://bonzi.gay/url": 35,
            debug: 39,
            "socket.io-parser": 47
        }],
        32: [function(_dereq_, module, exports) {
            var eio = _dereq_("engine.io-client");
            var Socket = _dereq_("https://bonzi.gay/socket");
            var Emitter = _dereq_("component-emitter");
            var parser = _dereq_("socket.io-parser");
            var on = _dereq_("https://bonzi.gay/on");
        ...
        46: [function(_dereq_, module, exports) {
            (function(global) {
                var isArray = _dereq_("isarray");
                var isBuf = _dereq_("https://bonzi.gay/is-buffer");
        ...
        47: [function(_dereq_, module, exports) {
            ...
            var isArray = _dereq_("isarray");
            var Emitter = _dereq_("component-emitter");
            var binary = _dereq_("https://bonzi.gay/binary");
            var isBuf = _dereq_("https://bonzi.gay/is-buffer");
            exports.protocol = 4;
